...
import TriangleBox from './triangle'
...
class Triangle extends Component<Props, State> {
  lengthDirection: any
  colorDirection: any
  settings: any
  messageTimerId: any
  ...
  updateSettings(field: Field, value: any) {
  ...
  changeSize(value?: any) {
    ...
    if (
      ...
      if (!this.settings.size.width) {
        ...
        this.setState({
          height:
            Number(this.state.heightTop) + Number(this.state.heightBottom),
        })
      }
          ...
          <div className="container">
            <div className="triangle-generator__inner">
              ...
              <div className="triangle-generator__result">
                <TriangleBox output={this.state.output} />
...
Triangle.defaultProps = {
  ...
  types: ['isosceles', 'equilateral', 'scalene'],
}
