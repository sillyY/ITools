    ...
    <div className="triangle-generator__settings">
      <section className="section">
        ...
        <div className="direction-table">
          {props.directions.map((direction: any, index: number) => {
            return (
              <div key={index} className="direction-table__cell">
                <span className="radio">
                  <input
                    ...
                    onChange={(e) =>
                      props.updateSettings('direction', e.currentTarget.value)
                    }
                  />
                  <label
                  ...
                  >
                    {capitalizeFirstLetter(splitCamelCase(direction))}
                  </label>
                </span>
              </div>
            )
            ...
            return (
              <span key={index} className="radio">
                <input
                  ...
                  disabled={
                    type === 'equilateral' && props.settings.disableEquilateral
                  }
                />
      ...
      <section className="section">
        ...
        <Photoshop
          color={props.color}
          onChangeComplete={(color: any) => props.updateSettings('color', color.hex)}
          disableAlpha={true}
        />
      </section>
    </div>
